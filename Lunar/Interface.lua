...
function Interface.NewChatText()
	...
	--Debug.Print("ok: " .. tostring(ok) .. ", color: " .. color.g .. ", channel: " .. channel)
	...
	-- local stringMsg = WStringToString(SystemData.Text)
	-- if (string.match(stringMsg, "Your skill in") and string.match(stringMsg, "has increased by")) then
	-- 	Debug.Print(tostring(SystemData.TextSourceID) .. ": " .. stringMsg .. "\r\n")
	-- end
